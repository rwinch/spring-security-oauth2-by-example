 ...
 */
@Component
public class ServiceOAuth2UserService
	...
	public ServiceOAuth2UserService(UserService users) {
		this.users = users;
	}
	...
	public OidcUser loadUser(OidcUserRequest oidcUserRequest)
		...
		return this.delegate.loadUser(oidcUserRequest).flatMap(this::create).block();
	}
